...
const LINKS = [
  ...
  {
    title: "Services",
    items: ["Timetable Generation", "Time Table Management", "TT Download"],
  },
  {
    title: "Company",
...
function Footer() {
  return (
    ...
    <footer className=" p-5 relative w-full  border-t-black-500 bg-gray-900 text-white">
    ...
    />
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear} <a href="/"> VIT TMS</a>. All
            Rights Reserved.
          </Typography>
